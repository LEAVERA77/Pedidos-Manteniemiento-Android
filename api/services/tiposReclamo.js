...
export const TIPOS_RECLAMO_POR_RUBRO = {
  municipio: [
    "Alumbrado Público (Foco quemado/Poste)",
    "Bacheo y Pavimento",
    "Recolección de Residuos / Poda",
    "Mantenimiento de Espacios Verdes",
    "Señalización y Semáforos",
    "Limpieza de Pluviales / Zanjas",
    "Recolección (otros)",
    "Cloacas",
    "Otros",
  ],
  cooperativa_agua: [
    "Pérdida en Vereda / Calzada",
    "Falta de Presión / Sin Servicio",
  ...
  cooperativa_electrica: [
    "Corte de Energía (Falta de Fase/Total)",
    "Cables Caídos / Peligro en Vía Pública",
    "Problemas de Tensión (Alta/Baja)",
    "Poste Inclinado / Dañado",
    "Cambio de Medidor / Conexión",
