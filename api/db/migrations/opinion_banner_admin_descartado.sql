...
--
-- No uses "Explain" / EXPLAIN en el editor de Neon con este script: EXPLAIN no admite DDL (ALTER).
-- Ejecutá solo las sentencias ALTER y COMMENT tal cual, sin prefijo EXPLAIN.
