-- ============================================================
-- GestorNova Android 1.0.25 (versionCode 25)
...
-- Descarga directa (mismo patrón que docs/NEON_app_version.sql):
-- ============================================================
...
VALUES (
    ...
    'GestorNova 1.0.25. Ajustá este texto si querés notas de release.',
    false
)
